...
// CreateOutboxMessage provides a mock function with given fields: ctx, order
func (_m *OrdersStorage) CreateOutboxMessage(ctx context.Context, order *models.Order) error {
	ret := _m.Called(ctx, order)
